...
const socialLinks: SocialLink[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className={iconClassName} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path
          d="M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2Zm4.64 6.84-1.51 7.13c-.11.5-.41.62-.83.39l-2.3-1.7-1.11 1.07c-.12.12-.23.23-.47.23l.17-2.35 4.28-3.86c.19-.17-.04-.26-.29-.1l-5.29 3.33-2.28-.71c-.5-.16-.51-.5.1-.74l8.9-3.43c.41-.15.77.1.63.74Z"
        />
      </svg>
    ),
  },
